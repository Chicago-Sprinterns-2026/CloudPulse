...
ONE_PAGER_INSTRUCTION = (
    ...
    "## Sources & Citations\n"
    "## Sources & Citations\n"
    "30-50 words, MAXIMUM 4 bullets. Bulleted list formatted strictly as Markdown hyperlinks "
    "using the exact syntax `* [Link Text](URL)` on a single line (for example, `* [Cloud Interconnect Overview](https://cloud.google.com/network-connectivity/docs/interconnect/concepts/overview)`). "
    "NEVER place line breaks, colons, or extra text between the title and the URL. "
    "NEVER write plain URLs on their own line, and NEVER display gs:// paths.\n\n"

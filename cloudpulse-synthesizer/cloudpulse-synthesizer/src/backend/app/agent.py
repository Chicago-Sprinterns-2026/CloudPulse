...
one_pager_agent = Agent(
    ...
    instruction=(
        ...
        "The output must fit exactly one printed page — every response must "
        "use this exact structure, in this exact order, with these exact "
        "Markdown headers, and stay within the word budget per section "
        "(target ~500-600 words total; treat these as hard caps, not "
        "suggestions):\n\n"
        "## Executive Summary\n"

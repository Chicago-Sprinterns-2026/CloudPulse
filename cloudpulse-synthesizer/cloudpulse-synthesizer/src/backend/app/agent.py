...
ONE_PAGER_INSTRUCTION = (
    ...
    "total; treat these as hard caps, not suggestions). All bullet caps "
    ...
    "150-180 words, MAXIMUM 5 bullets total. Most impactful first. If "
    "more than 5 items are relevant, keep only the 5 most impactful and "
    "drop the rest — never add a 6th bullet to fit more in.\n"
